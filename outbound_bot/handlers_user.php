...
function pay_with_wallet($chat, $mid, $tg, $plan_id) {
    ...
    if (try_auto_deliver($oid)) {
        edit($chat, $mid, "✅ پرداخت انجام شد و کانفیگ به‌صورت <b>خودکار</b> برای شما ارسال شد.\n\n🧾 شماره سفارش: <b>#{$oid}</b>\nاز بخش «📦 سفارش‌های من» هم قابل مشاهده است.");
        return;
    }
    edit($chat, $mid, "✅ پرداخت از کیف پول با موفقیت انجام شد.\n\n🧾 شماره سفارش: <b>#{$oid}</b>\n📦 کانفیگ شما به‌صورت دستی توسط ادمین آماده و ارسال خواهد شد. لطفاً منتظر بمانید.");
